...
<div id="sena1">
	...
	<label>Documento de indetidad:</label>
	<label id="seg">No.</label><br>
	<label>Programa de Formación:</label><br>
	<label>Ficha Caracterización Sofíaplus:</label><br>
	<label>Competencia que cursa:</label>
	<label id="seg">Trimestre que cursa:</label><br>
	<label>Fecha reporte:</label><br>
	<label>Primer fecha:</label><br>
	<label>Segunda fecha:</label><br>
	<label>Tercera fecha:</label><br>
<div id="causas">	
